...
public class MarcoPrincipal extends JFrame {
	...
	public JLabel lblCdigoProducto;
	public JLabel lblTipoProducto;
	public JLabel lblValorProducto_1;
	...
	public MarcoPrincipal() {
		...
		public void initialize() {
			...
			frmComercialLaRojita.setResizable(false);
			...
			ProductosInventario.setBounds(10, 45, 646, 414);
			panel2.add(ProductosInventario);
			
			panel_5 = new JPanel();
			panel_5.setBounds(52, 11, 558, 30);
			panel2.add(panel_5);
			panel_5.setLayout(null);
			
			lblNewLabel_7 = new JLabel("Nombre Producto");
			lblNewLabel_7.setFont(new Font("Yu Gothic Medium", Font.PLAIN, 11));
			lblNewLabel_7.setBounds(24, 11, 91, 14);
			panel_5.add(lblNewLabel_7);
			
			lblCdigoProducto = new JLabel("C\u00F3digo Producto\r\n");
			lblCdigoProducto.setFont(new Font("Yu Gothic Medium", Font.PLAIN, 11));
			lblCdigoProducto.setBounds(143, 11, 85, 14);
			panel_5.add(lblCdigoProducto);
			
			lblTipoProducto = new JLabel("Tipo Producto");
			lblTipoProducto.setFont(new Font("Yu Gothic Medium", Font.PLAIN, 11));
			lblTipoProducto.setBounds(246, 11, 76, 14);
			panel_5.add(lblTipoProducto);
			
			lblValorProducto_1 = new JLabel("Valor Producto");
			lblValorProducto_1.setFont(new Font("Yu Gothic Medium", Font.PLAIN, 11));
			lblValorProducto_1.setBounds(352, 11, 76, 14);
			panel_5.add(lblValorProducto_1);
			
			lblNewLabel_17 = new JLabel("Stock");
			lblNewLabel_17.setFont(new Font("Yu Gothic Medium", Font.PLAIN, 11));
			lblNewLabel_17.setBounds(463, 11, 37, 14);
